...
const UserProfile = () => {
  ...
  return (
    <form
      ...
      className="d-flex m-5 flex-column w-75 mx-auto border-bottom"
    >
      <div className="d-flex justify-content-between m-3">
        <h2>Contact Details</h2>
        <button
          className="h-25 border-2 border-danger text-danger bg-white"
          type="button"
        >
          Cancel
        </button>
      ...
      <div className="d-flex">
        ...
        <div className="d-flex m-3">
          ...
          <input className="h-100" type="file" onChange={handleChange} />
        </div>
      </div>
      <div>
        <button className="bg-dark text-white rounded p-1 m-2" type="submit">
          Update
        </button>
      </div>
    </form>
